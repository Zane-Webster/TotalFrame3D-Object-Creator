		...
		unsigned char aoResultRGB[3]) /* { 0 , 0 , 0 } */
{
		...
		COLORREF crCustColors[16] = {
			RGB(13,2,33), // dark blue purple
			RGB(36,23,52), // washed blue purple
			RGB(84,19,136), // purple purple
			RGB(12,47,99), // dark blue
			RGB(2,55,136), // water blue
			RGB(93,164,166), // teal
			RGB(146,0,117), // dark magenta
			RGB(209,52,52), // washed red
			RGB(240,38,38), // bright red
			RGB(253,55,119), // salmon
			RGB(158,40,22), // burnt orange
			RGB(44,255,5), // neon green
			RGB(75,181,60), // darker green
			RGB(63,58,71), // dark gray purple/steel
			RGB(25,25,25), // dark gray
			RGB(225,225,225) // light gray
		};
